---
name: claude-example-plugin-example-command
description: [claude-plugins/example-plugin] An example user-invoked skill that demonstrates frontmatter options and the skills/<name>/SKILL.md layout
