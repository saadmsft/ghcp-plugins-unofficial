---
name: claude-session-report-session-report
description: [claude-plugins/session-report] Generate an explorable HTML report of Claude Code session usage (tokens, cache, subagents, skills, expensive prompts) from ~/.claude/projects transcripts.
---
